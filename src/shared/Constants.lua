...
Constants.BuildVersion = "0.5.334"
...
Constants.Remotes = {
	...
	VictoryBrickRead = "VictoryBrickRead",
}
...
Constants.Tags = {
	...
	CaveFlashlightReminder = "DontTouchIt_CaveFlashlightReminder",
...
Constants.Prologue = {
	...
	ContainmentIdleRumbleDelaySeconds = 10,
	ContainmentIdleRumbleIntervalSeconds = 14,
	ContainmentIdleRumbleMinGapAfterInteractionSeconds = 7,
	ContainmentIdleRumbleDuration = 1.35,
	ContainmentIdleRumbleIntensity = 0.16,
	DarkLighting = {
...
Constants.AudioAssets = {
	...
	SecretDoors = {
		LibraryRevealSoundId = "rbxassetid://139444721219064",
		LibraryRevealVolume = 0.52,
		LibraryRevealSeconds = 2.8,
	},
	RoomAmbience = {
		TVRoom = {
...
Constants.BunkerEnergy = {
	...
	FirstContainmentPassiveDrainMultiplier = 5,
	FirstContainmentBunkerDrainMultiplier = 4,
	FirstContainmentWalkingDrainMultiplier = 1.4,
	FirstContainmentInteractionEnergyCostMultiplier = 3,
	BaseActionFeed = 0.25,
	DiscoveryFeed = 0.75,
	RepeatFeedDecay = 0.1,
